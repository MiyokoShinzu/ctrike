        ...
        <div class="container d-flex flex-column">
            <div class="row">
                <div class="col-11 col-lg-10 text-center mx-auto mt-1">
                    ...
                    <h3 class="mt-3">C-Trike Predictive Maintenance System</h3>
                </div>
                                ...
                                <div class="m-sm-3">
                                    ...
                                    <form method="post" action="">
                                        ...
                                        <div class="d-grid gap-2 mt-3">
                                            <button type="submit" name="login" class="btn btn-success p-2">Log in</button>
                                         
                                            <p style="color: #05823fff; text-align: center; font-size: 0.8em;">Forgot Password?</p>
                                        </div>
                                    </form>
                                </div>
                            </div>
